...
#This program attempts to replicate the photo in assignment 20
    ...
    for col in range(mapShape[1]):
        if elevations[row,col] <= 0:
           ...
           floodMap[row,col,0] = 1.0     #Set the red channel to 100%
            ...
            #Below the storm surge of Hurricane Sandy (flooding likely)
           floodMap[row,col,0] = .5     #Set the red channel to 100%
           floodMap[row,col,1] = .5     #Set the green channel to 100%
           floodMap[row,col,2] = .5     #Set the blue channel to 100%
        else:
